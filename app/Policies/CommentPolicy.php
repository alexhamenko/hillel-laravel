...
class CommentPolicy
{
    ...
    {
        return $user->id === $comment->user_id || in_array($user->role_name, ['super_admin', 'admin', 'author']);
    }
    ...
    {
        return $user->id === $comment->user_id || in_array($user->role_name, ['super_admin', 'admin']);
    }
